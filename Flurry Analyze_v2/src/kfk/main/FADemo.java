...
//		String apiKey = "CWV3S4TYHR93Z9TYPWR9";
//		String starDate = "2014-08-06";
//		String endDate = "2014-08-06";
//		String version = "4.0.5";
//		String interval = "2014_08_08-2014_08_09";
//		FADemo fa = new FADemo();
//		ExportExcel excel = new ExportExcel();
//		fa.au = new ActiveUserBean();
//		fa.au.setVersionName(version);
//		fa.BugRate(container, apiKey, starDate, endDate, version, interval);
//		fa.Crash(container, version, interval);
//		excel.makeBugRate(container, fa.au);
//	}
	...
	public void BugRate(String[][] container, ActiveUserBean activeUserBean, String apiKey, String starDate, String endDate, String version, String interval) {
		...
		try {
			 ...
			 */
			if (auList != null) {
				System.out.println("ApplicationVersion:" + activeUserBean.getVersionName()
						+ " StartDate:" + activeUserBean.getStartDate() + " EndDate:"
